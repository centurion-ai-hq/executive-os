---
description: Finds where time and errors actually go in a described workflow and gives one committed fix. Use when the user says "audit this process", "where is the time going", "what should we automate first", "walk me through fixing this workflow", or describes a recurring process that feels slow or error-prone.
