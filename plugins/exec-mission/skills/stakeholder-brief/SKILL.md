...
2. Research their giving history and stated priorities using whatever web search tool is available:
   ...
   in one line each rather than presenting it as prior knowledge.
3. Connect their stated priorities directly to the organisation's actual work: name the specific
   program or outcome that matches, not a generic mission statement.
4. State the ask plainly: the specific number, and what it funds. A brief that avoids naming the
   number is not useful in the room.
5. Predict what they will push back on, based on their history or stated priorities (a past pattern
   of smaller gifts, a stated preference for a different cause area, a reporting requirement this
   organisation has not met before). Label this a prediction, not a certainty.
6. Keep the whole brief to one page. Depth goes in a short appendix section below the fold, not
   into the main page.

## Output
One page: who they are (with sources), what they care about, the connection to this organisation's
