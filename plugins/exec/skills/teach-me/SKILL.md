---
description: "A topic taught properly over several exchanges, one step at a time, checking understanding before moving on. Not a one-shot definition. Use when the user says 'teach me', 'walk me through', 'I want to learn X', 'explain this step by step', 'tutor me on this', 'should we build this', or wants to actually understand a topic rather than get a one-off answer."
