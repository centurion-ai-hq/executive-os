...
when_to_use: Fire this when the user says anything like "look this up", "research this", "find out", "who is", "who owns", "dig into", "what is the market", "compare the options out there", "is that true", "what do we know about", "background on", "look into".
---
